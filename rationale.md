...
Kami menggunakan metode `POST` untuk endpoint pengajuan pinjaman (`/v1/loans/apply`) karena:
...
Untuk memberikan informasi yang akurat bagi tim Frontend, kami menetapkan status kode berikut:
